...
SECRET_KEY = 'django-insecure-)em(bkdc!00q$i#@d&agyq!^qk28a7eyu@7)50ne#5*ju@m$^6'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['127.0.0.1', 'hashflix-projeto.herokuapp.com']
...
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': 'htenretpq',
    'API_KEY': '928687878629347',
    'API_SECRET': 'kX6jwnWwN6K44WHXYtQ_rQvt5O0'
}
